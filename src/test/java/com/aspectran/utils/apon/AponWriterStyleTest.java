 ...
 */
public class AponWriterStyleTest {

    @Test
    public void testTextInSingleLineStyle() throws IOException {
        ...
        Assert.assertFalse(result.contains(SYSTEM_NEW_LINE));
        Assert.assertFalse(result.contains("|"));
    }

    @Test
    public void testTextInCompactStyle() throws IOException {
        Parameters params = new VariableParameters();
        params.putValue("key1", "val1");
        params.putValue("text", "line1" + SYSTEM_NEW_LINE + "line2" + SYSTEM_NEW_LINE + "line3");
    ...
    @Test
    public void testStyleConversions() throws IOException, AponParseException {
        ...
        Assert.assertEquals("line1" + SYSTEM_NEW_LINE + "line2", params2.getString("text"));
        ...
        Assert.assertEquals("val1", params3.getString("key1"));
        Assert.assertEquals("line1" + SYSTEM_NEW_LINE + "line2", params3.getString("text"));
    }

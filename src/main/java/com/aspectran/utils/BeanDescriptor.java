...
public class BeanDescriptor {
    ...
    private static final Map<Class<?>, BeanDescriptor> cache = Collections.synchronizedMap(new WeakHashMap<Class<?>, BeanDescriptor>(256));
    ...
    private final Map<String, Class<?>> getterTypes = new HashMap<String, Class<?>>();

    private final Map<String, Method> setterMethods = new HashMap<String, Method>();

    private final Map<String, Class<?>> setterTypes = new HashMap<String, Class<?>>();
    ...
    private Set<String> addGetterMethods(@NonNull Method[] methods) {
        Set<String> nonSerializableReadPropertyNames = new HashSet<String>();
     ...
     * @param type the class for which to look up the method cache

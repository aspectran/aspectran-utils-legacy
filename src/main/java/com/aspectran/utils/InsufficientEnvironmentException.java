...
public class InsufficientEnvironmentException extends IllegalStateException {
    ...
    public String getPrettyMessage() {
        ...
        sb.append(hr2).append(SystemUtils.LINE_SEPARATOR);
        sb.append(" ").append(title).append(SystemUtils.LINE_SEPARATOR);
        sb.append(hr1).append(SystemUtils.LINE_SEPARATOR);

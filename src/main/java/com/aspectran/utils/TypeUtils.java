...
public abstract class TypeUtils {
     ...
     */
    private static final Map<Class<?>, Class<?>> primitiveWrapperTypeMap = new HashMap<Class<?>, Class<?>>(32);

    /**
     * A map with primitive types as keys and corresponding wrapper types as values.
     * For example: {@code int.class -> Integer.class}.
     */
    private static final Map<Class<?>, Class<?>> primitiveTypeToWrapperMap  = new HashMap<Class<?>, Class<?>>(32);
